import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, Inject, Input, OnDestroy, OnInit, ViewChild, ViewEncapsulation, forwardRef } from '@angular/core';
...
export class WySliderComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  private createDraggingObservables() {
    ...
    [mouse, touch].forEach(source => {
      ...
      // if(pluckKey.indexOf('touches') !== -1){
      //   pluckObj.pluckKeyTouch = {...pluckKey}
      // } else{
      //   pluckObj.pluckKey = {...pluckKey}
      // }
